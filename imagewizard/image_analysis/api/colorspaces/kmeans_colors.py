...
class Kmeans(object):
    ...
    def run(self, image):
        ...
        while self.shouldExit(iterations) is False:
            ...
            print ("finding color clusters - iteration: ", iterations)
    ...
    def shouldExit(self, iterations):
        ...
        for idx in range(self.k):
            dist = self.calcDistance(numpy.array(self.clusters[idx].centroid),
    ...
    def showCentroidColours(self):
        ...
        for idx, cluster in enumerate(self.clusters):
            ...
            image = Image.new("RGB", (200, 200),
                              tuple(int(x) for x in cluster.centroid))
            self.save('centroid_color_{}_cv'.format(idx), image)
            image.show()
    ...
    def showClustering(self):
        ...
        self.save('clustered_image', colourMap)
        colourMap.show()
...
# def main():
#     image = Image.open("to_del/lenna.png")
#     k = Kmeans()
#     result = k.run(image)
#     print(result)
#     k.showImage()
